...
-- load test file
local test0 = lqueso.elf32('test1')
...
solver(quesoGraph,
       {
        createAssertion('eip', 15, '#x08048466'),
        createAssertion('eip', 0,  '#x0804840c')
       },
       {'eax_6'})
